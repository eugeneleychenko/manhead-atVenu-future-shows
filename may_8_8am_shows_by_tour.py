...
tours = []
with open("all_tours.csv", mode="r") as csvfile, open("all_shows.csv", "w", newline="") as showsfile:
    ...
    for row in csvreader:
        tours.append({"artistName": row["artistName"], "account_uuid": row["account_uuid"], "tour_name": row["tour_name"], "tour_uuid": row["tour_uuid"]})
        shows_query = """
        ...
        """
        # Assuming 'tours' is a list of dictionaries with tour information
        for tour in tours:
