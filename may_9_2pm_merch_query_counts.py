...
with open('all_shows.csv', mode='r') as csvfile, open('all_counts.csv', mode='w', newline='') as countsfile:
    ...
    for row in csv_reader:
        ...
        for count in counts_data:
            ...
            count_in = count_in if count_in is not None else 0
            count_out = count_out if count_out is not None else 0
            comps = comps if comps is not None else 0

            quantity_sold = count_in + merch_adds_quantity - count_out - comps
