...
with open("all_merch_items_5_9.csv", "w", newline="") as csvfile:
    writer = csv.DictWriter(csvfile, fieldnames = [
    "account_uuid", "name", "category", "uuid", "productType", "sku", 
    "size", "price", "merchItemUuid", "variantUuid"
])
    writer.writeheader()
